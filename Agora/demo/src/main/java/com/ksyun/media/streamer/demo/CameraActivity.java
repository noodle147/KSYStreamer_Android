...
import com.ksyun.media.agora.kit.KSYAgoraStreamer;
...
public class CameraActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStreamer.setVideoBitrate(600*1000);
    ...
    private void updateDebugInfo() {
        ...
        mDebugInfo = String.format(Locale.getDefault(),
                ...
                mStreamer.getCurrentUploadKBitrate(), KSYAgoraStreamer.getVersion());
    }
    ...
    private KSYAgoraStreamer.OnInfoListener mOnInfoListener = new KSYAgoraStreamer.OnInfoListener() {
        @Override
    ...
    private KSYAgoraStreamer.OnErrorListener mOnErrorListener = new KSYAgoraStreamer.OnErrorListener() {
        @Override
