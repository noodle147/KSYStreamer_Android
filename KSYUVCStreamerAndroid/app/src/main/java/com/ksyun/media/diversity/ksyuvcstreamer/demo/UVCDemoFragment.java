...
public class UVCDemoFragment extends DemoFragment {
    private static final String TAG = "UVCDemoFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.uvc_demo_fragment, container, false);
        ButterKnife.bind(this, view);
        return view;
    }

    protected void loadParams(UVCCameraActivity.BaseStreamConfig config, String url) {
        // initial value
    ...
    public void start(String url) {
        UVCCameraActivity.BaseStreamConfig config = new UVCCameraActivity.BaseStreamConfig();
        loadParams(config, url);
        UVCCameraActivity.startActivity(getActivity(), config, UVCCameraActivity.class);
    }
}
