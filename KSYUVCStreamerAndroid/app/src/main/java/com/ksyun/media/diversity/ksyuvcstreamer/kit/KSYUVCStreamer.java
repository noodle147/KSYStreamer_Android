package com.ksyun.media.diversity.ksyuvcstreamer.kit;
...
import com.ksyun.media.diversity.ksyuvcstreamer.capture.UVCCameraCapture;
...
/**
 * Streamer use UVC Camera as video capture.
 */

public class KSYUVCStreamer {
    private static final String TAG = "KSYUVCStreamer";
    ...
    protected boolean mEnableStreamStatModule = true;
    ...
    protected UVCCameraCapture mUVCCameraCapture;
    ...
    public KSYUVCStreamer(Context context) {
        if (context == null) {
    ...
    protected void initModules() {
        ...
        // Camera preview
        mUVCCameraCapture = new UVCCameraCapture(mGLRender);
        ...
        mUVCCameraCapture.getImgTexSrcPin().connect(mImgTexScaleFilter.getSinkPin());
    ...
    /**
     * Get {@link UVCCameraCapture} module instance.
     *
     * @return UVCCameraCapture instance.
     */
    public UVCCameraCapture getUVCCameraCapture() {
        return mUVCCameraCapture;
    }
    ...
    public void setRotateDegrees(int degrees) throws IllegalArgumentException {
        ...
        mUVCCameraCapture.setOrientation(degrees);
    }
     ...
     * <p>
     * The set resolution would take effect on next {@link #startCameraPreview()} call.<br/>
     * <p>
    ...
    public void setCameraCaptureResolution(int width, int height) throws IllegalArgumentException {
        ...
        mUVCCameraCapture.setPreviewSize(width, height);
    }
     ...
     * call, if called not in previewing mode.<br/>
     ...
     * Set preview fps.<br/>
     * <p>
     * The set fps would take effect on next {@link #startCameraPreview()} call.<br/>
     * <p>
    ...
    public float getCurrentPreviewFps() {
        return mUVCCameraCapture.getCurrentPreviewFps();
    }
    ...
    public void setFrontCameraMirror(boolean mirror) {
        ...
        // UVC Camera is always front camera
        mImgTexMixer.setMirror(mIdxCamera, !mFrontCameraMirror);
    ...
    protected void setPreviewParams() {
        ...
        mWaterMarkCapture.setTargetSize(mTargetWidth, mTargetHeight);
        mUVCCameraCapture.setOrientation(mRotateDegrees);
        if (mPreviewFps == 0) {
            mPreviewFps = CameraCapture.DEFAULT_PREVIEW_FPS;
        }
        mUVCCameraCapture.setPreviewFps(mPreviewFps);
    ...
    public KSYStreamer.OnErrorListener getOnErrorListener() {
        return mOnErrorListener;
    }

    public KSYStreamer.OnInfoListener getOnInfoListener() {
