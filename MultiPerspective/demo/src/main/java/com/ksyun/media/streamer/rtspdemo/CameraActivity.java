...
public class CameraActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            if (mIsSecondScreen) {
                mStartRTSP.setText("启动第二视角");
            } else {
                mStartRTSP.setText("连接第二视角");
            }
        }
